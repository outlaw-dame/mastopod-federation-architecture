...
| Pixelfed | source release `v0.12.7`, commit `e33026a9e5334d2c124a7321f8b15d4329b8961f` | `followers` row in Pixelfed's MySQL database | Executable in `activitypub-real-multi-implementation-federation.yml` |
