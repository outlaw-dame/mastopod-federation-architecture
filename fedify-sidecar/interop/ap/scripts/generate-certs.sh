...
for host in sidecar gotosocial mastodon akkoma activitypods pixelfed.test bonfire.test misskey.test friendica.test castopod.test peertube.test loops.test owncast.test activitypods.test; do
