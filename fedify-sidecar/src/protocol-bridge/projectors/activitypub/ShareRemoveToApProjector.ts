...
export class ShareRemoveToApProjector implements CanonicalProjector<ActivityPubProjectionCommand> {
  ...
  public async project(
    ...
    const announceId = buildSocialActivityId(actor.activityPubActorUri, "Announce", shareTargetKey(intent));
