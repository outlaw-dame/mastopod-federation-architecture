...
describe("APDM completed-delivery retention policy", () => {
  it("enforces a seven-day minimum retention horizon", () => {
    expect(MIN_COMPLETED_DELIVERY_TTL_MS).toBe(7 * 24 * 60 * 60 * 1000);
  ...
  it("fails safe to the seven-day floor for non-finite input", () => {
